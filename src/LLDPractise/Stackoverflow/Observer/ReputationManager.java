...
public class ReputationManager implements PostObserver{
    ...
    private static final int DOWNVOTE_REP_PENALTY = -1;
    private static final int POST_DOWNVOTED_REP_PENALTY = -2;
    ...
    public void onPostEvent(Event event) {
        ...
        switch (event.getType()){
            ...
            case DOWNVOTE_ANSWER:
                ...
                break;
            case ACCEPT_ANSWER:
                postAuthor.updateReputation(POST_DOWNVOTED_REP_PENALTY);
                break;
        }
    }
}
